...
<body>
    ...
    <section id="contact-info">
        <div class="center">                
            ...
            <p class="lead">Upwork is now worldwide. follow the instructions bellow to contact with us</p>
        </div>
        <div class="gmap-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-7 map-content">
                        <ul class="row">
                            <li class="col-sm-6">
                                <address>
                                    <h5>Head Office</h5>
                                    <p>1217 Metro Scout Market <br>
                                    Tumon, MP 96911</p>
                                    <p>Phone:670-898-2847 <br>
                                    Email Address:tcld@gmail.com</p>
                                </address>
