            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="/home/aboutUs">About Us</a></li>
                        <li><a href="/home/login">Log In</a></li>
                        <li><a href="/home/signup">Sign In</a></li>
                        <li class="dropdown">
    ...
    <section id="about-us">
        <div class="container">
			<div class="center wow fadeInDown">
				<h2>About Upwork</h2>
				<p class="lead">Upwork is a online Market Place, Where you can hire freelancer for your work and also can work as freelancer. We have a well-formed team. Nowadays our serivices spreaded out all over the world Stay with us. Thank you</p>
			</div>
				...
				<div id="carousel-slider" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="/resources/home/images/slider_one.jpg" class="img-responsive" alt=""> 
					   </div>
					   <div class="item">
							<img src="/resources/home/images/slider_one.jpg" class="img-responsive" alt=""> 
					   </div> 
				...
				<div class="row clearfix">
					<div class="col-md-4 col-sm-6">	
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								<div class="pull-left">
									<a href="#"><img class="media-object" src="/resources/home/images/man1.jpg" alt=""></a>
								</div>
					...
					<div class="col-md-4 col-sm-6 col-md-offset-2">	
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								<div class="pull-left">
									<a href="#"><img class="media-object" src="/resources/home/images/man2.jpg" alt=""></a>
								</div>
								<div class="media-body">
									<h4>Jhon Doe</h4>
									<h5>Founder and CEO</h5>
				...
				<div class="row clearfix">   
					<div class="col-md-4 col-sm-6 col-md-offset-2">	
						<div class="single-profile-bottom wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
							<div class="media">
								<div class="pull-left">
									<a href="#"><img class="media-object" src="/resources/home/images/man3.jpg" alt=""></a>
								</div>
					...
					<div class="col-md-4 col-sm-6 col-md-offset-2">
						<div class="single-profile-bottom wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
							<div class="media">
								<div class="pull-left">
									<a href="#"><img class="media-object" src="/resources/home/images/man4.jpg" alt=""></a>
								</div>
								<div class="media-body">
									<h4>Jhon Doe</h4>
									<h5>Founder and CEO</h5>
