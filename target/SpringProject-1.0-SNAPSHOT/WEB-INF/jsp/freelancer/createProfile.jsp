                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form class="form-group" method="post" action="/freelancer/save1" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" id="focusedInput" type="text" name="hourlyRate">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Employment History</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="employmentHistory">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Upload Profile</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" id="focusedInput" type="file" name="profilePicture">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control btn-success" id="focusedInput" type="submit" value="Create Profile">
                                            </div>
                                        </div>
                                    </form>
                                </div>
