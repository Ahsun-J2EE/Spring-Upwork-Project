...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" href="\resources\home\images\logo.png">
        ...
        <link href="/resources/client/others/hireTalent.css" rel="stylesheet" />
        <!-- date picker -->
        ...
        <section id="container" class="">
            ...
            <section id="main-content">
                <section class="wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="page-header" style="text-align: center"><i></i><b>Browse Talents</b></h3>
                        </div>
                    </div>
                    <div id="container">
                        <c:forEach items="${map.fList}" var="f">
                            ...
                            <div class="main" style="background-color: white">
                                <div class="form-group"><img src="/resources/freelancer/profile/${f.profilePicture}" alt=""
                                                             width="90" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                                    <h5 class="mb-0"><b>${f.fullName}</b></h5><span class="text-uppercase"><b>${f.designation}</b></span>
                                    <p>${f.employmentHistory}
                                        MATTERS.</p><span></span> <button class="btn btn-primary" data-toggle="modal" data-target="#myModal">Invite to
                                        Job</button>
                                </div>
                            </div>
                        </c:forEach>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1"
                                                          rows="3">Hello! I'd like to invite you to take a look at the job I've posted. Please submit a proposal if you're available and interested. Best Regards Ahsun Habib</textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button class="btn btn-success" data-toggle="modal" data-target="#myModal2">Send Invitation</button>
                                        </div>
                                        <!-- Modal footer -->
