                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form class="form-group" method="post" action="/client/update" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Client Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="job_code" value="${cj.client_name}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Job Code</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="job_code" value="${cj.jobCode}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Job ID</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="id" value="${cj.id}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Job Title</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="job_title" value="${cj.job_title}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Category</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="job_title" value="${cj.category}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="description" class="form-control" name="description">${cj.description}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" name="project_type">
                                                    <option value="One Time">${cj.project_type}</option>

                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Freelancer Level</label>
                                            <div class="col-sm-10">
                                                <select class="form-control" name="freelancer_level">
                                                    <option value="Entry Level">${cj.freelancer_level}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" id="focusedInput" type="text" name="budget_amount" value="${cj.budget_Amount}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Job Duration</label>
                                            <div class="col-sm-10">
                                                <select class="form-control" name="job_duration">
                                                    <option value="Less Than a Week">${cj.job_duration}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="submit" class="btn-info" value="Update Job" >
                                            </div>
                                        </div>
                                    </form>
                                </div>
