...
<html lang="en">
    ...
    <head>
        ...
        <title>Client Dashboard | Upwork</title>
    ...
    <body>
                                ...
                                <div class="panel-body">
                                    <div class="col-lg-2 col-sm-2">
                                        ...
                                        <div class="follow-ava">
                                            <img src="/resources/client/img/profile-widget-avatar.jpg" alt="">
                                        </div>
                                        <h6>Administrator</h6>
                                    </div>
                                            ...
                                            <div class="profile-activity">
                                                <div class="act-time">
                                                    <div class="activity-body act-in">
                                                        ...
                                                        <div class="text">
                                                            <a href="#" class="activity-img"><img class="avatar" src="/resources/client/img/chat-avatar.jpg" alt=""></a>
        ...
        <!-- jquery knob -->
        <script src="/resources/client/assets/jquery-knob/js/jquery.knob.js"></script>
