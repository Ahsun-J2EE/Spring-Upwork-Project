                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form class="form-group" method="post" action="/client/save1" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" id="focusedInput" type="text" name="budget_amount">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Additional File</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" id="focusedInput" type="file" name="additional_file">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control btn-success" id="focusedInput" type="submit" value="Submit">
                                            </div>
                                        </div>
                                    </form>
                                </div>
