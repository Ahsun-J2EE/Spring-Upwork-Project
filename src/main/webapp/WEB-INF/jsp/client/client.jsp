...
<html lang="en">
    ...
    <body>
                ...
                <section class="wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li><i class="fa fa-home"></i><a href="/client/client">Home</a></li>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table class="table bootstrap-datatable countries">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img src="/resources/client/img/Germany.png" style="height:18px; margin-top:-2px;"></td>
                                                <td>Germany</td>
                                                <td>2563</td>
                                                <td>1025</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><img src="/resources/client/img/India.png" style="height:18px; margin-top:-2px;"></td>
                                                <td>India</td>
                                                <td>3652</td>
                                                <td>2563</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><img src="/resources/client/img/Spain.png" style="height:18px; margin-top:-2px;"></td>
                                                <td>Spain</td>
                                                <td>562</td>
                                                <td>452</td>
                                                <td>
                                        ...
                                        <ul class="chats">
                                            ...
                                            <li class="by-me">
                                                ...
                                                <div class="avatar pull-left">
                                                    <img src="/resources/client/img/user.jpg" alt="" />
                                                </div>
                                            ...
                                            <li class="by-other">
                                                ...
                                                <div class="avatar pull-right">
                                                    <img src="/resources/client/img/user22.png" alt="" />
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <span class="profile-ava pull-right">
                                                <img alt="" class="simple" src="/resources/client/img/avatar1_small.jpg">
                                                Jenifer smith
                                            </span>
                                        </div>
                                    </div>
        ...
        <script src="/resources/client/js/jquery-ui-1.10.4.min.js"></script>
        <script src="/resources/client/js/jquery-1.8.3.min.js"></script>
        <script type="text/javascript" src="/resources/client/js/jquery-ui-1.9.2.custom.min.js"></script>
        <!-- bootstrap -->
        ...
        <!-- charts scripts -->
        <script src="assets/jquery-knob//resources/client/js/jquery.knob.js"></script>
        <script src="/resources/client/js/jquery.sparkline.js" type="text/javascript"></script>
        <script src="assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
        <script src="/resources/client/js/owl.carousel.js"></script>
        <!-- jQuery full calendar -->
        <<script src="/resources/client/js/fullcalendar.min.js"></script>
        <!-- Full Google Calendar - Calendar -->
        <script src="assets/fullcalendar/fullcalendar/fullcalendar.js"></script>
        <!--script for this page only-->
        <script src="/resources/client/js/calendar-custom.js"></script>
        <script src="/resources/client/js/jquery.rateit.min.js"></script>
        <!-- custom select -->
        <script src="/resources/client/js/jquery.customSelect.min.js"></script>
        <script src="assets/chart-master/Chart.js"></script>

        <!--custome script for all page-->
        <script src="/resources/client/js/scripts.js"></script>
        <!-- custom script for this page-->
        <script src="/resources/client/js/sparkline-chart.js"></script>
        <script src="/resources/client/js/easy-pie-chart.js"></script>
        <script src="/resources/client/js/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="/resources/client/js/jquery-jvectormap-world-mill-en.js"></script>
        <script src="/resources/client/js/xcharts.min.js"></script>
        <script src="/resources/client/js/jquery.autosize.min.js"></script>
        <script src="/resources/client/js/jquery.placeholder.min.js"></script>
        <script src="/resources/client/js/gdp-data.js"></script>
        <script src="/resources/client/js/morris.min.js"></script>
        <script src="/resources/client/js/sparklines.js"></script>
        <script src="/resources/client/js/charts.js"></script>
        <script src="/resources/client/js/jquery.slimscroll.min.js"></script>
        <script>
            //knob
            $(function () {
                $(".knob").knob({
