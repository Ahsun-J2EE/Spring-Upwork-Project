    ...
    <body>
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header" style="text-align: center"><i></i><b>My Posted Jobs</b></h3>
                    </div>
                                    ...
                                    <div class="row " style="background-color: white; padding-top:10px; padding-bottom: 10px">
                                        ...
                                        <div class="col-md-8 px-3">
                                            <div class="card-block px-3">
                                                ...
                                                <input type="button" class="btn-info"  onclick="location.href = '/client/edit/${job.id}'" value="Edit Job" >
                                                <input type="button" class="btn-danger" onclick="location.href = '/client/delete/${job.id}'" value="Delete Job" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
